...
CuboidMaker.prototype.surfaceArea = function() {return 2* ((this.width*this.height) + (this.width * this.length)+ (this.length * this.height))}
...
class CuboidMakerTwo{
  ...
  surfaceArea() {return 2* ((this.width*this.height) + (this.width * this.length)+ (this.length * this.height)) };
